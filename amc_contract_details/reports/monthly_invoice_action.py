...
class MonthlyInvoiceWizard(models.TransientModel):
    _name = 'monthly.invoice.wizard'
    ...
    def action_create_report(self):
        ...
        datas = {
            'ids': self._ids,
            'data': data,
            'model': 'monthly.invoice.wizard'
        }
        return self.env.ref(
            'amc_contract_details.monthly_invoice_xls_report'
